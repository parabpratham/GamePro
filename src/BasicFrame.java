...
public class BasicFrame extends JFrame
{
	...
	/*
	 * Create a paint() method to override the one in JFrame. This is where the drawing happens. We don't have to call it in our program, it gets called automatically whenever the frame needs to be
	 * redrawn, like when it it made visible or moved or whatever.
	 */
